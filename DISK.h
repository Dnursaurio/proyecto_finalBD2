...
public:
    ...
    void Escribir_sector(long long superficie, long long pista, long long sector, const char* buffer) 
    {
        ...
        archivo.close();
        cout << "Datos escritos en sector (" << superficie << "," << pista << "," << sector << ")" << endl;
    }
    ...
    long long getCapacidadSector() 
    {
        return capacidad_sector;
    }
    long long getTotalSectores() 
    {
        return nro_superficies * nro_pistas * nro_sectores;
    }
